...
public void user_enters_valid_details_in_form_by_clicking_on_Sign_Up_link() {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
...
@Then("User enters the valid firstname{string}")
public void user_enters_the_valid_firstname(String firstname) {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
	driver.findElement(By .name("firstName")).sendKeys(firstname);
}

@Then("User enters the valid lastname{string}")
public void user_enters_the_valid_lastname(String lastname) {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
	driver.findElement(By .name("lastName")).sendKeys(lastname);
}

@Then("User enters the valid password{string}")
...
@Then("User enters the valid confirm password{string}")
public void user_enters_the_valid_confirm_password(String confirmpassword) {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
	driver.findElement(By .name("confirmPassword")).sendKeys(confirmpassword);
}

@Then("User enters the valid gender")
public void user_enters_the_valid_gender() {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
	driver.findElement(By .xpath("//*[@id=\"gender\"]")).click();
}

@Then("User enters the valid email{string}")
...
@Then("User enters the valid mobile number{string}")
public void user_enters_the_valid_mobile_number(String mobile) {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
	driver.findElement(By .name("mobileNumber")).sendKeys(mobile);
}

@Then("User choose the valid date of birth{string}")
public void user_choose_the_valid_date_of_birth(String birthdate) {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
	driver.findElement(By .name("dob")).sendKeys(birthdate);
}

@Then("User enters the valid address{string}")
public void user_enters_the_valid_address(String address) {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
	driver.findElement(By .name("address")).sendKeys(address);
}

@Then("User enters the required security Question")
public void user_enters_the_required_security_Question() {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
...
public void user_choose_the_valid_answer() {
    // Write code here that turns the phrase above into concrete actions
   // throw new cucumber.api.PendingException();
